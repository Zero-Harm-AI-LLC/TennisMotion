...
import { type CameraApi, CameraType, type CaptureData } from '../../native/types';
import { Orientation } from '../../native/';
import type { CameraProps } from '../../native/CameraProps';
...
export default function CameraExample (onBack: { onBack: () => void })  {
